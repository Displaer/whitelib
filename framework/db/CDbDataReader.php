 ...
 * for more details.
 *
 * @property boolean $isClosed Whether the %02d is closed or not.
...
class CDbDataReader extends CComponent implements Iterator, Countable
{
	...
	/**
	 * Advances the %02d to the next row in a result set.
	...
	/**
	 * Advances the %02d to the next result when reading the results of a batch of statements.
	...
	/**
	 * whether the %02d is closed or not.
	 * @return boolean whether the %02d is closed or not.
	 */
	 ...
	 * Note, even there's no row in the %02d, this still gives correct column number.
	...
	public function rewind()
	{
		if($this->_index<0)
		{
			...
			throw new CDbException(Yii::t('yii','CDbDataReader cannot rewind. It is a forward-only %02d.'));
	}
